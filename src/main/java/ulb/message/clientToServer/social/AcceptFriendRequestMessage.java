...
public class AcceptFriendRequestMessage implements ClientToServerMessage {
    private final String receiverUsername;
    private final String senderUsername;

    public AcceptFriendRequestMessage(String receiverUsername, String senderUsername) {
