...
public class ChatDatabaseRepository implements ChatRepository {
	...
	/**
	 * Deletes old messages from a conversation to keep only the MAX_MESSAGES most recent ones.
	 *
	 * @param usernameA The name of one user
	 * @param usernameB The name of the other user
	...
	/**
	 * Completes prepared statements.
	 *
	 * @param stmt The prepared statement to complete
	 * @param usernameA The name of a user of the conversation
	 * @param usernameB The name of the other user of the conversation
	 * @param startIndex The index of the first username in the statement variables
	 * @throws SQLException If an SQL error occurs
	 */
