...
public class BattleWindow {
	...
	public void displayMessagesSequentially(List<String> rawLogs, Integer hpAfterFirstActionSelf,
		...
		graphicsHelper.displayMessagesSequentially(rawLogs, hpAfterFirstActionSelf, hpAfterFirstActionOpponent,
				finalSnapshot, () -> currentSnapshot, this::renderBattle, onComplete);
	}
	 ...
	 */
	public record InventoryEntry(String itemId, String itemName, String itemDescription, String itemSpritePath,
	                             int quantity, boolean usable) {
	}
	 ...
	 */
	public record BugemonEntry(String bugemonId, String bugemonName, String bugemonSpritePath, boolean ko,
	                           boolean active, boolean selectable) {
	}
	 ...
	 */
	public record AbilityEntry(String abilityId, String abilityName, String abilityDescription, Type abilityType,
