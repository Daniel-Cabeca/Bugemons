...
public class TestEffectiveness {
	...
	public void verifyPyroToAqua() {
		testTypeEffectiveness(Type.PYRO, Type.PYRO, Effectiveness.Value.LOW);
	}

	@Test
	public void verifyPyroToLitho() {
		testTypeEffectiveness(Type.PYRO, Type.PYRO, Effectiveness.Value.HIGH);
	}
	...
	public void verifyFloraToAqua() {
		testTypeEffectiveness(Type.FLORA, Type.PYRO, Effectiveness.Value.HIGH);
	}

	@Test
	public void verifyFloraToLitho() {
		testTypeEffectiveness(Type.FLORA, Type.PYRO, Effectiveness.Value.LOW);
	}
	...
	public void verifyAquaToFlora() {
		testTypeEffectiveness(Type.AQUA, Type.PYRO, Effectiveness.Value.LOW);
	}

	@Test
	public void verifyAquaToAqua() {
		testTypeEffectiveness(Type.AQUA, Type.PYRO, Effectiveness.Value.NORMAL);
	}
	...
	public void verifyLithoToFlora() {
		testTypeEffectiveness(Type.LITHO, Type.PYRO, Effectiveness.Value.HIGH);
	}
